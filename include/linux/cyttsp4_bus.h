...
extern struct bus_type cyttsp4_bus_type_heat;
...
struct cyttsp4_core_driver {
	...
	int (*set_loader)(struct cyttsp4_device *ttsp, cyttsp4_loader_func func);
...
extern int cyttsp4_register_driver_heat(struct cyttsp4_driver *drv);
extern void cyttsp4_unregister_driver(struct cyttsp4_driver *drv);
extern void cyttsp4_unregister_driver_heat(struct cyttsp4_driver *drv);

extern int cyttsp4_register_core_driver(struct cyttsp4_core_driver *drv);
extern int cyttsp4_register_core_driver_heat(struct cyttsp4_core_driver *drv);
extern void cyttsp4_unregister_core_driver(struct cyttsp4_core_driver *drv);
extern void cyttsp4_unregister_core_driver_heat(
		struct cyttsp4_core_driver *drv);

extern int cyttsp4_register_device(struct cyttsp4_device_info const *dev_info);
extern int cyttsp4_register_device_heat(
		struct cyttsp4_device_info const *dev_info);
extern int cyttsp4_unregister_device(char const *name, char const *core_id);
extern int cyttsp4_unregister_device_heat(
		char const *name, char const *core_id);

extern int cyttsp4_register_core_device_heat(
...
extern int cyttsp4_add_adapter_heat(
		char const *id, struct cyttsp4_ops const *ops,
		struct device *parent);

extern int cyttsp4_del_adapter(char const *id);
extern int cyttsp4_del_adapter_heat(char const *id);
