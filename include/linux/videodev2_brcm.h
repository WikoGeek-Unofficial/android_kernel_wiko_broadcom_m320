...
#define V4L2_CID_CAM_PREVIEW_ONOFF	(V4L2_CID_RCU_CONTROLS_BASE + 0x1C)
#define V4L2_CID_CAM_CAPTURE		(V4L2_CID_RCU_CONTROLS_BASE + 0x1D)
#define V4L2_CID_CAM_RECORD		(V4L2_CID_RCU_CONTROLS_BASE + 0x22)

enum v4l2_record_mode {
	STOP_RECORD = 0,
	START_RECORD
};
...
#define V4L2_CID_CAMERA_SCENE_MODES       (V4L2_CID_RCU_CONTROLS_BASE+0x23)

enum v4l2_scene_modes {
	SCENE_MODE_BASE = 0,
	SCENE_MODE_NONE,
	SCENE_MODE_PORTRAIT,
...
#define V4L2_CID_CAMERA_FLASH_MODE	(V4L2_CID_RCU_CONTROLS_BASE + 0x1B)
...
#define V4L2_CID_CAMERA_BRIGHTNESS	(V4L2_CID_RCU_CONTROLS_BASE + 0x12)
enum v4l2_ev_mode {
	EV_BASE = -5,
	EV_MINUS_4,
	EV_MINUS_3,
...
#define V4L2_CID_CAMERA_WHITE_BALANCE	(V4L2_CID_RCU_CONTROLS_BASE + 0x16)
enum v4l2_wb_mode {
	WHITE_BALANCE_BASE = -1,
	WHITE_BALANCE_AUTO,
...
#define V4L2_CID_CAMERA_EFFECT		(V4L2_CID_RCU_CONTROLS_BASE + 0x14)
...
#define V4L2_CID_CAMERA_ISO		(V4L2_CID_RCU_CONTROLS_BASE + 0x25)
enum v4l2_iso_mode {
	ISO_BASE = 0,
	ISO_AUTO,
	ISO_50,
...
#define V4L2_CID_CAMERA_METERING_EXPOSURE	\
					(V4L2_CID_RCU_CONTROLS_BASE + 0x24)
...
#define V4L2_CID_CAMERA_CONTRAST	(V4L2_CID_RCU_CONTROLS_BASE + 0x27)
...
#define V4L2_CID_CAMERA_SHARPNESS	\
					(V4L2_CID_RCU_CONTROLS_BASE + 0x26)
...
#define V4L2_CID_CAMERA_TOUCH_AF_AREA	(V4L2_CID_RCU_CONTROLS_BASE + 0x19)
enum v4l2_touch_af {
	TOUCH_AF_BASE = 0,
	TOUCH_AF_STOP,
	TOUCH_AF_START,
...
#define V4L2_CID_CAMERA_SET_AUTO_FOCUS	(V4L2_CID_RCU_CONTROLS_BASE + 0x1A)
...
#define V4L2_CID_CAMERA_FOCUS_MODE	(V4L2_CID_RCU_CONTROLS_BASE + 0x18)
enum v4l2_focusmode {
	FOCUS_MODE_BASE = -1,
	FOCUS_MODE_AUTO,
	FOCUS_MODE_OFF,
...
#define V4L2_CID_CAMERA_AUTO_FOCUS_RESULT	\
					(V4L2_CID_RCU_CONTROLS_BASE + 0x1F)
#define V4L2_CID_CAMERA_FRAME_RATE	(V4L2_CID_RCU_CONTROLS_BASE + 0x17)
...
#define V4L2_CID_CAMERA_ANTI_BANDING	(V4L2_CID_RCU_CONTROLS_BASE + 0x15)
...
#define V4L2_CID_CAMERA_GET_FLASH_ONOFF		(V4L2_CID_RCU_CONTROLS_BASE + 119)
...
#define V4L2_CID_CAM_CAPTURE_DONE	(V4L2_CID_RCU_CONTROLS_BASE + 0x1E)
...
#define V4L2_CID_CAMERA_EXP_TIME	(V4L2_CID_RCU_CONTROLS_BASE + 0x20)
#define V4L2_CID_PARAMETERS \
		(V4L2_CID_RCU_CONTROLS_BASE + 0X21)
...
#define VIDIOC_THUMB_G_FMT \
	_IOR('V', BASE_VIDIOC_PRIVATE+1, struct v4l2_format)
#define VIDIOC_THUMB_S_FMT \
	_IOWR('V', BASE_VIDIOC_PRIVATE+2, struct v4l2_format)
...
#define VIDIOC_S_RECOGNITION\
	_IOWR('V', BASE_VIDIOC_PRIVATE+5, struct v4l2_recognition)
#define VIDIOC_G_RECOGNITION\
	_IOR('V', BASE_VIDIOC_PRIVATE+6, struct v4l2_recognition)
...
#define VIDIOC_JPEG_G_PACKET_INFO\
	_IOR('V', BASE_VIDIOC_PRIVATE+7, struct v4l2_jpeg_packet_info)
...
#define VIDIOC_SENSOR_G_OPTICAL_INFO\
	_IOR('V', BASE_VIDIOC_PRIVATE+8, struct v4l2_sensor_optical_info)
