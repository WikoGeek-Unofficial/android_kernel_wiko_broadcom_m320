...
#define SEC_THERMISTOR_ADC_READ_TRIES 5
extern int d2153_get_ap_temperature(int opt);
				   ...
				   char *buf)
{
	...
	temper = d2153_get_ap_temperature(D2153_OPT_TEMP);
				   ...
				   char *buf)
{
	...
	adc = d2153_get_ap_temperature(D2153_OPT_ADC);
