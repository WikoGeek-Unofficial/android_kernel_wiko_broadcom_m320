...
static struct pinctrl_map l4020p_pinctrl_map[] __initdata = {
	/* D2153 */
...
static void __init board_init(void)
{
...
#ifdef custom_t_DEBUG_KERNEL_SPEED
	printk("[%s]:start\n",__FUNCTION__);
#endif
	...
	sh_pfc_register_mappings(l4020p_pinctrl_map,
				 ARRAY_SIZE(l4020p_pinctrl_map));
	r8a7373_pinmux_init();
	...
	//++  add broadcom patch:camera driver by suwei 2014 4  26
...
DT_MACHINE_START(L4020AP_C, "l4020ap_c")
