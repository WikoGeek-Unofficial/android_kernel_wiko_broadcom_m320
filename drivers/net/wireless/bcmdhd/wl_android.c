...
#define PRIVATE_COMMAND_MAX_LEN	8192
    ...
    printk(">>>>> sleep 400ms for setting band ...");
    msleep(400);
    printk(">>>>> sleep 400ms for setting band done");
    ...
    printk(">>>>> sleep 1s for setting country ...");
    msleep(1000);
    printk(">>>>> sleep 1s for setting country done");
	}
#endif /* WL_CFG80211 */
