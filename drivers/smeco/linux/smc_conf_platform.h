...
#define SMC_HOST_ACCESS_WAKEUP(spinlock, timeout) \
	smc_host_access_wakeup(spinlock, timeout)
#define SMC_HOST_ACCESS_SLEEP(spinlock) smc_host_access_sleep(spinlock)
  #else
