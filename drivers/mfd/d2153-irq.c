...
#ifdef custom_t_CUSTOM
static struct wake_lock irq_wake_lock;
#endif
...
#ifdef custom_t_CUSTOM
			wake_lock_timeout(&irq_wake_lock,HZ);
#endif			
			d2153_irq_call_handler(d2153, i);
			/* Now clear EVENT registers */
...
#ifdef custom_t_CUSTOM
	wake_lock_init(&irq_wake_lock,WAKE_LOCK_SUSPEND, "irq_wake_lock");
#endif
