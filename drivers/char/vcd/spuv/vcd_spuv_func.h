...
#define VCD_SPUV_FUNC_PCM_PROC_DUAL_MIC_FILE_NAME	"pcm_proc_dual_mic.bin"
...
#define VCD_SPUV_FUNC_PCM_DUAL_MIC_SD_PATH			\
				"/mnt/sdcard/spuv/pcm_proc_dual_mic.bin"
...
/* sdram static area */
#define SPUV_FUNC_SDRAM_NON_CACHE_AREA_SIZE	0x280000
...
#define SPUV_FUNC_SDRAM_SPUV_SEND_MSG_BUFFER	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00240000)
#define SPUV_FUNC_SDRAM_RECORD_BUFFER_0		( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00241000)
#define SPUV_FUNC_SDRAM_RECORD_BUFFER_1		( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00241280)
#define SPUV_FUNC_SDRAM_PLAYBACK_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00242000)
#define SPUV_FUNC_SDRAM_PLAYBACK_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00242280)
#define SPUV_FUNC_SDRAM_VOIP_DL_TEMP_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00243000)
#define SPUV_FUNC_SDRAM_VOIP_DL_TEMP_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00243280)
#define SPUV_FUNC_SDRAM_VOIP_UL_TEMP_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00243800)
#define SPUV_FUNC_SDRAM_VOIP_UL_TEMP_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00243A80)
#define SPUV_FUNC_SDRAM_PT_PLAYBACK_BUFFER_0	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00243D00)
#define SPUV_FUNC_SDRAM_PT_PLAYBACK_BUFFER_1	( \
			SPUV_FUNC_SDRAM_NON_CACHE_AREA_TOP + 0x00244480)
...
extern void *vcd_spuv_func_get_pcm_static_dual_mic_buffer(void);
extern void *vcd_spuv_func_get_diamond_sdram_buffer(void);
extern int dual_mic_is_present(void);
