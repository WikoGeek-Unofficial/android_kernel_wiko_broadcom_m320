...
int d2153_platform_regulator_init(struct d2153 *d2153)
{
	...
	/* set MISC_MCTL */
	/*Enable BBAT and disable DIG_CLK corresponding to MCTL1=0
	 * This disables PMU CLK during deep sleep*/
	reg_val = D2153_BBAT_MCTL0_MASK | D2153_BBAT_MCTL1_MASK |
		D2153_BBAT_MCTL2_MASK | D2153_BBAT_MCTL3_MASK;
	reg_val |= D2153_DIG_CLK_MCTL0_MASK | D2153_DIG_CLK_MCTL2_MASK;
