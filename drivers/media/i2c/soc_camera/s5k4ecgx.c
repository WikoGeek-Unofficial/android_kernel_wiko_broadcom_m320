...
static DEVICE_ATTR(rear_camtype, 0444, subcamtype_S5K4ECGX_show, NULL);
static DEVICE_ATTR(rear_camfw, 0444, subcamfw_S5K4ECGX_show, NULL);
static DEVICE_ATTR(rear_flash, 0200, NULL, maincamflash_S5K4ECGX_store);
static DEVICE_ATTR(rear_vendorid, 0444, subvendorid_S5K4ECGX_show, NULL);
