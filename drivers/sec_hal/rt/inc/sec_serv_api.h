...
/* To be removed when references removed */
#define SEC_SERV_A3SP_STATE_INFO                                0x1000001E
/* This will replace the A3SP state info */
#define SEC_SERV_A3SP_STATE_REQUEST                             0x1000001E
...
#define SEC_SERV_DEVICE_CRYPT                                   0x10000037
#define SEC_SERV_HASH_CALC                                      0x10000038

#define SEC_SERV_ARBMODE_SET                                    0x10000039
 ...
 * Cryption operations
 */
#define SEC_SERV_DEVICE_CRYPT_OP_DECRYPT                        0x00000000
#define SEC_SERV_DEVICE_CRYPT_OP_ENCRYPT                        0x00000008
#define SEC_SERV_DEVICE_CRYPT_OP_ENCRYPT_ONE_WAY                0x00000010

#define SEC_IV_LENGTH                                           16
...
#define MC_FC_SLEEP                             ((uint32_t)(-3))
#define MC_FC_SECONDARY_CORE_SLEEP              ((uint32_t)(-304))
#define MC_FC_BCM_L2_CACHE_CONTROL              ((uint32_t)(-305))

#define MC_FC_DEBUG_MODE_SET                    (FASTCALL_OWNER_SIP | 0x200)
#define MC_FC_DYNAMIC_MEMORY_ALLOC              (FASTCALL_OWNER_SIP | 0x201)
#define MC_FC_DYNAMIC_MEMORY_FREE               (FASTCALL_OWNER_SIP | 0x202)
#define MC_FC_ARB_MODE_SET                      (FASTCALL_OWNER_SIP | 0x203)
#define MC_FC_POWER_OFF                         (FASTCALL_OWNER_SIP | 0x204)
#define MC_FC_A3SP_CONTROL                      (FASTCALL_OWNER_SIP | 0x205)

#define A3SP_PUBLIC_REQ                         (1<<0)
#define A3SP_SECURE_REQ                         (1<<1)
